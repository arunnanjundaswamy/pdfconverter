...
namespace PDFConverterConsole.Converters
{
    public class WordConverter
    {
        ...
        public WordConverter(IConfiguration configuration, ILogger<WordConverter> logger, LibreOfficePDFConverter pdfConverter) 
        {
        ...
        public void ConvertToPDF()
        {
            ...
            {
                _logger.LogInformation($"No word files to convert.");
                return;
            }
        ...
        private string[] GetFileNames()
        {
            try
            {
                ...
                string[] files = Directory.GetFiles(inputDir, "*.doc?", SearchOption.AllDirectories);
            ...
            {
                _logger.LogError($"Error getting file names in word document converter", ex);
            }
            return null;
        }
    }
