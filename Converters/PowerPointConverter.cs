...
namespace PDFConverterConsole.Converters
{
    public class PowerPointConverter
    {
        ...
        public PowerPointConverter(IConfiguration configuration, ILogger<WordConverter> logger, LibreOfficePDFConverter pdfConverter)
        {
        ...
        public void ConvertToPDF()
        {
            ...
            {
                _logger.LogInformation($"No ppt files to convert.");
                return;
            }
        ...
        private string[] GetFileNames()
        {
            try
            {
                ...
                string[] files = Directory.GetFiles(inputDir, "*.ppt?", SearchOption.AllDirectories);
            ...
            {
                _logger.LogError($"Error getting file names in ppt converter", ex);
            }
            return null;
        }
    }
