...
======================================================================
LibreOffice 24.2:n LueMinut-tiedosto
======================================================================
...
Kansio RPMS (tai DEBS) sisältää myös paketin nimeltä libreoffice24.2-freedesktop-menus-24.2.0.1-1.noarch.rpm (tai libreoffice24.2-debian-menus_24.2.0.1-1_all.deb, tai vastaavan). Tämä paketti soveltuu kaikille Linux-jakeluille, jotka tukevat Freedesktop.orgin määrityksiä (https://en.wikipedia.org/wiki/Freedesktop.org). Se on tarkoitettu sellaisia Linux-jakeluita varten, joille ei ollut ohjeita edellä.
...
Toivomme, että viihdyt uuden LibreOffice 24.2:n parissa ja liityt joukkoomme verkossa.
